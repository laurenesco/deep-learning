...
class PyTorchBasics:
    ...
    def make_it_pytorch_1(x: torch.Tensor) -> torch.Tensor:
        ...
        """
        return x[::3] # select every 3rd element
    ...
    def make_it_pytorch_2(x: torch.Tensor) -> torch.Tensor:
        ...
        """
        return x.max(dim=-1).values # return the max value of last dimension
        raise NotImplementedError
    ...
    def make_it_pytorch_3(x: torch.Tensor) -> torch.Tensor:
        ...
        """
        return torch.unique(x, sorted=True) # return unique elements, sorted
        raise NotImplementedError
    ...
    def make_it_pytorch_4(x: torch.Tensor, y: torch.Tensor) -> torch.Tensor:
        ...
        """
        return (y > x.mean()).sum() # return count of elements where y is greater than mean of x
        raise NotImplementedError
    ...
    def make_it_pytorch_6(x: torch.Tensor) -> torch.Tensor:
        ...
        """
        return x.diagonal() # return diagonal elements
        raise NotImplementedError
    ...
    def make_it_pytorch_7(x: torch.Tensor) -> torch.Tensor:
        ...
        Solution length: 27 characters
        """
        return x.flip(1).diagonal() # return diagonal elements (mirror)
        raise NotImplementedError
    ...
    def make_it_pytorch_8(x: torch.Tensor) -> torch.Tensor:
        ...
        Solution length: 22 characters
        """
        return x.cumsum(dim=0) # return cumulative sum
        raise NotImplementedError
    ...
    def make_it_pytorch_9(x: torch.Tensor) -> torch.Tensor:
        ...
        """
        return x.cumsum(0).cumsum(1) # return cumulative sum of rows and columns
        raise NotImplementedError
    ...
    def make_it_pytorch_10(x: torch.Tensor, c: torch.Tensor) -> torch.Tensor:
        ...
        """
        return torch.where(x < c, torch.tensor(0.0, dtype=x.dtype), x) # set all elements < c to 0
        raise NotImplementedError
    ...
    def make_it_pytorch_11(x: torch.Tensor, c: torch.Tensor) -> torch.Tensor:
        ...
        """
        return torch.nonzero(x < c, as_tuple=False).T # get row and column indices of all elements < c
        raise NotImplementedError
    ...
    def make_it_pytorch_12(x: torch.Tensor, m: torch.BoolTensor) -> torch.Tensor:
        ...
        Solution length: 11 characters
        """
        return x[m] # return elements where mask is true
        raise NotImplementedError
    ...
    def make_it_pytorch_extra_1(x: torch.Tensor, y: torch.Tensor) -> torch.Tensor:
        ...
        Solution length: 36 characters
        """
        return torch.diff(torch.cat((x, y))) # return differences of elements in concatenated x an dy
        raise NotImplementedError
    ...
    def make_it_pytorch_extra_2(x: torch.Tensor, y: torch.Tensor) -> torch.Tensor:
        ...
        """
        return (torch.abs(x[:, None] - y) < 1e-3).any(dim=1).sum() # return count of elements in x "equal" to an element in y
        raise NotImplementedError
